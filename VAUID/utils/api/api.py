HOST = 'https://app.mval.qq.com'
GOHOST = f'{HOST}/go'


SummonerAPI = f"{GOHOST}/user_profile/query/user"
...
ViveAPI = f'{GOHOST}/agame/career/seasonoverview?&app_scope=lol'
PFAPI = f'{GOHOST}/agame/career/performance/agent?&app_scope=lol'
